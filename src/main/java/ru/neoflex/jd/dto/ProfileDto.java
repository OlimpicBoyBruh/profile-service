...
public class ProfileDto {
    ...
    private UUID id;
    @NotNull(groups = {Validate.BankGroup.class, Validate.GosUslugiGroup.class})
    ...
    @NotNull(groups = {Validate.MailGroup.class, Validate.BankGroup.class, Validate.GosUslugiGroup.class})
    ...
    @NotNull(groups = {Validate.GosUslugiGroup.class})
    @Schema(description = "Место рождения", defaultValue = "г.Москва")
    private String birthPlace;
    @NotNull(groups = {Validate.MobileGroup.class, Validate.GosUslugiGroup.class})
    ...
    @NotNull(groups = {Validate.MailGroup.class})
